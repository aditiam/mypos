...
<head>
	...
	<title>MyPOS - by CodingHacker</title>
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview <?= $this->uri->segment(1) == 'category' ||
											...
											$this->uri->segment(1) == 'item' ? 'class="active"' : '' ?>">
						<a href="#">
					...
					<?php if ($this->fungsi->user_login()->level == 1) { ?>
						...
						<li <?= $this->uri->segment(1) == 'user' ? 'class="active"' : '' ?>><a href="<?= site_url('user') ?>"><i class="fa fa-circle-o"></i> <span>Users</span></a></li>
					<?php } ?>
				</ul>
			</section>
		</aside>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2019 <a href="">CodingHacker</a>.</strong> All rights
			reserved.
		</footer>
